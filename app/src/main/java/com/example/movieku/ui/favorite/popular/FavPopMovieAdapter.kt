...
class FavPopMovieAdapter :
    PagedListAdapter<PopularMovieEntity, FavPopMovieAdapter.MovieViewHolder>(DIFF_CALLBACK) {
    ...
    fun getSwipedData(swipedPosition: Int): PopularMovieEntity? = getItem(swipedPosition)
                ...
                itemView.setOnClickListener {
                    itemView.context.startActivity(
                        Intent(
                            ...
                            putExtra(
                                AppConstant.INTENT.EXTRA_TYPE,
                                AppConstant.INTENT.TAG_POP_MOVIE
                            )
                        })
                }
            }
